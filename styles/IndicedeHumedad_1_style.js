...
var style_IndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.119796 && value <= -0.050640) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.050640 && value <= 0.018517) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.018517 && value <= 0.087673) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.087673 && value <= 0.156830) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.156830 && value <= 0.225987) {
            style = [ new ol.style.Style({
