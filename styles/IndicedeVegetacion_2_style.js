...
var style_IndicedeVegetacion_2 = function(feature, resolution){
    ...
    if (value >= 0.097975 && value <= 0.195167) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.195167 && value <= 0.292359) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.292359 && value <= 0.389551) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.389551 && value <= 0.486743) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.486743 && value <= 0.583935) {
            style = [ new ol.style.Style({
